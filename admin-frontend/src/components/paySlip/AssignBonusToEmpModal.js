...
const AssignBonusToEmpModal = ({
  closeModal,
  setAssignBonusToEmpModalData,
  assignBonusToEmpModalData,
  employeeOptions,
  allBonusTypes,
  assignBonusTypeToEmployee,
}) => {
  const months = [
    "January",
    "February",
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    assignBonusTypeToEmployee(assignBonusToEmpModalData);
    closeModal();
  };
  return (
    <div
            ...
            <div className="grid gap-4 mb-4 grid-cols-2">
              ...
              <div className="col-span-1 sm:col-span-1">
                ...
                <select
                  ...
                  value={assignBonusToEmpModalData?.bonusId || ""}
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <select
                  className="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5  border-gray-500 placeholder-gray-400 focus:ring-primary-500 focus:border-primary-500"
                  value={assignBonusToEmpModalData?.month || ""}
                  placeholder="Select Bonus type"
                  required
                  onChange={(e) => {
                    setAssignBonusToEmpModalData((prev) => ({
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input
                  ...
                  value={assignBonusToEmpModalData?.bonusAmount || ""}
                  required
                  onChange={(e) => {
                    setAssignBonusToEmpModalData((prev) => ({
                      ...prev,
...
export default AssignBonusToEmpModal;
